...
internal class NavigationLambdaValidator : ExpressionVisitor
{
    ...
    public virtual void Validate(LambdaExpression lambda)
    {
    ...
    public override Expression? Visit(Expression? expression)
    {
        ...
        if (expression.NodeType is not (
            ...
            throw new ArgumentException("The navigation lambda's expression can only use the parameter, property accessors and type conversions.");
    ...
    protected override Expression VisitParameter(ParameterExpression parameter)
    {
        ...
        if (WasParameterFound)
            throw new ArgumentException("The navigation lambda's expression can not use the parameter more than once.", nameof(parameter));
